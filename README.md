...
大学生向けの日商簿記2級・仕訳問題反復学習アプリです。学生用アプリはGitHub Pagesで公開し、学習記録はブラウザ内保存とFirebaseへ保存します。学生は大学専用URLから学籍番号と6桁暗証番号を入力すると、端末やブラウザが変わっても同じ記録を復元できます。管理者はFirebase Authenticationでログインし、大学別・学籍番号別の成績確認、問題の公開対象・公開期間の設定ができます。
